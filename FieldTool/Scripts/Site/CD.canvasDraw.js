...
CD.canvasDraw = {
    ...
    createUserEvents: function () {
        ...
        var press = function (e) {
            // Mouse down location
            //var rect = CD.canvasDraw.canvas.getBoundingClientRect();
            ...
            var sizeHotspotStartX,
                          mouseX = (e.changedTouches ? e.changedTouches[0].pageX : e.pageX) - offset.left,
        ...
        drag = function (e) {
            ...
            console.log("Prevent the whole page from dragging if on mobile");
            e.preventDefault();
        },
        ...
        CD.canvasDraw.canvas.addEventListener("mouseup", release, false);
    ...
    init: function init() {
        ...
        CD.canvasDraw.crayonImage.src = AbsoluteURL + "/Content/images/crayon-outline.png";

        CD.canvasDraw.markerImage.onload = CD.canvasDraw.resourceLoaded;
        CD.canvasDraw.markerImage.src = AbsoluteURL + "/Content/images/marker-outline.png";

        CD.canvasDraw.eraserImage.onload = CD.canvasDraw.resourceLoaded;
        CD.canvasDraw.eraserImage.src = AbsoluteURL + "/Content/images/eraser-outline.png";

        CD.canvasDraw.crayonBackgroundImage.onload = CD.canvasDraw.resourceLoaded;
        CD.canvasDraw.crayonBackgroundImage.src = AbsoluteURL + "/Content/images/crayon-background.png";

        CD.canvasDraw.markerBackgroundImage.onload = CD.canvasDraw.resourceLoaded;
        CD.canvasDraw.markerBackgroundImage.src = AbsoluteURL + "/Content/images/marker-background.png";

        CD.canvasDraw.eraserBackgroundImage.onload = CD.canvasDraw.resourceLoaded;
        CD.canvasDraw.eraserBackgroundImage.src = AbsoluteURL + "/Content/images/eraser-background.png";

        CD.canvasDraw.crayonTextureImage.onload = CD.canvasDraw.resourceLoaded;
        CD.canvasDraw.crayonTextureImage.src = AbsoluteURL + "/Content/images/crayon-texture.png";

        CD.canvasDraw.outlineImage.onload = CD.canvasDraw.resourceLoaded;
        CD.canvasDraw.outlineImage.src = AbsoluteURL + "/Content/images/trafficIntersection.png";
