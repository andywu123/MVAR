        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
           bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
            ...
            bundles.Add(new ScriptBundle("~/bundles/accidents").Include(
                        ...
                        "~/Scripts/Site/CD.ViewAccidentForm.js",
                        //"~/Scripts/Site/signature_pad.js",
                        //"~/Scripts/Site/CD.InkSign.js",
                        "~/Scripts/Site/CD.services.js",
                        "~/Scripts/Site/helpers.js"
                        //"~/Scripts/Site/signature.js"
                       ));
            ...
            bundles.Add(new StyleBundle("~/Content/Styles").Include(
                        ...
                        //"~/Content/css/jquery.signaturepad.css",
                        "~/Content/DataTables/css/jquery.dataTables.min.css",
                        //"~/Content/DataTables/css/datatable_table.css",
