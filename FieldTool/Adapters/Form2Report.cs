...
namespace FieldTool.Adapters
{
    public class Form2Report
    {
        ...
        private static List<MVAR_Occupants> convert2occupants(FormDataCollection form, int caseId)
        {
            ...
            var sex = form.Get("chk_OcpSex_edit_M");
            if (sex == "on")
            {
                occupant.Sex = 1;
            }
        ...
        private static MVAR_AccidentReport convert2AccidentReportNew(FormDataCollection form)
        {
            ...
            var chk_seatBelt_edit = form.Get("chk_seatBelt_edit");
            if (chk_seatBelt_edit == "on")
            {
                reportInfo.Seatbelt_InUse = 1;
            }
            else
            {
                reportInfo.Seatbelt_InUse = 0;
            }
            ...
            reportInfo.CaseOwner = HttpContext.Current.User.Identity.Name;
            return reportInfo;
        }
        ...
        private static List<VehiclePost> convert2vehiclesPost(List<MVAR_Vehicles> vehicles)
        {
            ...
            foreach (MVAR_Vehicles vt in vehicles)
            {
                ...
                if (vt.Driver_DOB != null)
                {
                    ...
                    v.Driver_DOB = dt.ToString("yyyy-MM-dd");
                }
                ...
                v.VehicleYear = vt.VehicleYear;
                v.VehicleState = vt.VehicleState;
                v.OtherSpecify = vt.OtherSpecify;

                v.Owner_Name = vt.Owner_Name;
                v.Owner_Phone = vt.Owner_Phone;
                v.Owner_PolicyNo = vt.Owner_PolicyNo;
                v.Owner_Address = vt.Owner_Address;
                v.Owner_InsuranceCom = vt.Owner_InsuranceCom;

                if (vt.Driver_ExpDate != null)
                {
                    var dt = (DateTime)vt.Driver_ExpDate;
                    v.Driver_ExpDate = dt.ToString("yyyy-MM-dd");
                }

                v.Driver_VehicleState = vt.Driver_VehicleState;
        ...
        private static List<ChargePost> convert2chargesPost(List<MVAR_Charges> charges)
        {
            ...
            foreach (MVAR_Charges ch in charges)
            {
                ...
                if (ch.Trial_Time != null)
                {
                    ...
                    c.Trial_Time = dt.ToString("yyyy-MM-dd HH:mm:ss");
                }
                chs.Add(c);
            }
        ...
        private static AccidentReportPost convert2AccidentReportPost(MVAR_AccidentReport accidentReport)
        {
            ...
            if (accidentReport.DriverSig != null)
            {
                report.DriverSig = Convert.ToBase64String(accidentReport.DriverSig);
            }

            if (accidentReport.SupervisorSig != null)
            {
                report.SupervisorSig = Convert.ToBase64String(accidentReport.SupervisorSig);
            }

            if (accidentReport.SafetyOfficerSig != null)
            {
                report.SafetyOfficerSig = Convert.ToBase64String(accidentReport.SafetyOfficerSig);
            }
            ...
            if (accidentReport.IntsSketch != null)
            {
                report.IntsSketch = Convert.ToBase64String(accidentReport.IntsSketch);
            }
        ...
        private static List<MVAR_Vehicles> convert2vehicles(List<VehiclePost> vehicles, int p)
        {
            ...
            foreach (VehiclePost vt in vehicles)
            {
                ...
                if (vt.Driver_DOB != "" && vt.Driver_DOB != null)
                {
                ...
                if (vt.Driver_ExpDate != "" && vt.Driver_ExpDate != null)
                {
                    v.Driver_ExpDate = Convert.ToDateTime(vt.Driver_ExpDate);
                }
        ...
        private static List<MVAR_Charges> convert2charges(List<ChargePost> charges, int p)
        {
            ...
            foreach (ChargePost ch in charges)
            {
                ...
                c.CityEmpl_Charge = ch.CityEmpl_Charge;
                c.Summons_No = ch.Summons_No;
                if (ch.Trial_Time != "" && ch.Trial_Time != null)
                {
        ...
        private static MVAR_AccidentReport convert2AccidentReport(AccidentReportPost accidentReport)
        {
            ...
            report.CaseId = accidentReport.CaseId;
            //report.DriverSig_URL = accidentReport.DriverSig_URL;
            if (accidentReport.DriverSign_Time != "" && accidentReport.DriverSign_Time != null)
            {
                report.DriverSign_Time = Convert.ToDateTime(accidentReport.DriverSign_Time);
            }
          

            if (accidentReport.CreateDate != "" && accidentReport.CreateDate != null)
            {
                report.CreateDate = Convert.ToDateTime(accidentReport.CreateDate);
            }


            if (accidentReport.LastEditDate != "" && accidentReport.LastEditDate != null)
            {
                report.LastEditDate = Convert.ToDateTime(accidentReport.LastEditDate);
            }
          

            if (accidentReport.SupervisorSig_Time != "" && accidentReport.SupervisorSig_Time != null)
            {
                report.SupervisorSig_Time = Convert.ToDateTime(accidentReport.SupervisorSig_Time);
            }


            if (accidentReport.SafetyOfficerSig_Time != "" && accidentReport.SafetyOfficerSig_Time != null)
            {
                report.SafetyOfficerSig_Time = Convert.ToDateTime(accidentReport.SafetyOfficerSig_Time);
            }

            if (accidentReport.Control1Call_Time != "" && accidentReport.Control1Call_Time != null)
            {
                report.Control1Call_Time = Convert.ToDateTime(accidentReport.Control1Call_Time);
            }

            if (accidentReport.AccidentTime != "" && accidentReport.AccidentTime != null)
            {
            ...
            report.Pedestrian_Involved = accidentReport.Pedestrian_Involved;
            report.AccidentDesc = accidentReport.AccidentDesc;
            report.IntsSketch = accidentReport.IntsSketch != null ? ObjectToByteArray(accidentReport.IntsSketch): null;
            report.Seatbelt_InUse = accidentReport.Seatbelt_InUse; 
        ...
        public static byte[] ObjectToByteArray(Object base64)
        {
            //BinaryFormatter bf = new BinaryFormatter();
            //using (var ms = new MemoryStream())
            //{
            //    bf.Serialize(ms, base64);
            //    return ms.ToArray();
            //}
